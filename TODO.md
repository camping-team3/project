# Forest Haven ERP Project TODO - Phase 3: Payment System
...
## 📝 비즈니스 규칙 (Payment Rules)
1. **결제 수단**: 즉시 확인이 가능한 '신용카드' 및 '간편결제'로 제한.
2. **선점 유효 시간**: 결제 진입 시점부터 최대 10분.
3. **정합성**: 클라이언트 콜백보다 서버 웹훅(Webhook) 신호를 우선하여 상태 반영.
4. **환불**: 예약 취소 승인 시 별도 외부 대시보드 접속 없이 시스템 내에서 자동 처리.
