...
- [x] **Payment 도메인 (100%):**
  ...
  - [x] 고객: 포트원(PortOne) V2 연동, 결제 검증, 결제 완료 시 예약 즉시 확정 로직 완료
  - [x] 관리자: 결제 내역 조회 로직 완료
- [ ] **Qna & Comment 도메인:**
...
- [x] **Reservation 도메인 (확장):**
  ...
  - [x] 관리자: 취소 요청 목록 조회 및 처리 로직 완료
  - [x] 정산 자동화: 예약 변경/취소 시 차액 결제 및 위약금 적용 부분 환불 로직 완료 (2026-03-24)

## 🛡️ Phase 4: 고도화 및 안정화 (40%)

**목표:** 운영 고도화, 환불 자동화, 서비스 안정성 확보

- [ ] **Refund 도메인:** 위약금 자동 계산, 관리자 '최종 승인' 후 환불 연동
- [x] **AI 기반 리뷰 관리 시스템 (100%):**
